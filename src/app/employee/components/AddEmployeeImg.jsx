...
const AddEmployeeImg = ({ setLogo, logo, loading, uploading, isSubmitted }) => {
      ...
      <Stack gap={"10px"}>
        ...
        >
          <Avatar
            ...
            color="blue"
            src={imgUrl || logo || "https://raw.githubusercontent.com/mantinedev/mantine/master/.demo/avatars/avatar-8.png"}
