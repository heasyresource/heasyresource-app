'use client'
import { Avatar, Button, Container, Flex, GridCol, Group, HoverCard, HoverCardDropdown, HoverCardTarget, Space, Stack, Text } from '@mantine/core';
    ...
    const message = data.map((item) => (
        ...
        >
            ...
            <Group justify='flex-start' style={{ paddingLeft: '38px' }}>
                <Text fz='sm' c='rgba(28, 28, 28, 0.4)'>Today</Text>
            </Group>
        </Flex>
    ))
    return (
